...
//The @service annotation means that Spring will scan this file as part of the scan configuration in beans.xml <context:component-scan base-package="com.pluralsight.cxfdemo" />
@Service
